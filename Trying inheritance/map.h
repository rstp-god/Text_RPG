...
public:
	...
	void mapopen()
	{
		...
		//1
		int x2 = 40; int y2 = 25; string s2 = "fort stockton"; int nei2[10]; int n2 = 2; nei2[0] = 0;nei2[1]=2;
		city city2(x2, y2, s2,nei2,n2);
		//2
		int x3 = 60; int y3 = 25; string s3 = "el dorado"; int nei3 [10]; int n3 = 2; nei3[0] = 1;nei3[1]=3;
		city city3(x3, y3, s3,nei3,n3);
		//3
		int x4 = 80; int y4 = 20; string s4 = "brady"; int nei4[10]; int n4 = 2; nei4[0] = 2;nei4[1]=4;
		city city4(x4, y4, s4,nei4,n4);
		//4
		int x5 = 90; int y5 = 20; string s5 = "san saba"; int nei5[10]; int n5 = 3; nei5[0] = 3; nei5[1] = 5;nei5[2]=9;
		city city5(x5, y5, s5,nei5,n5);
		//5
		int x6 = 100; int y6 = 17; string s6 = "lampasas"; int nei6[10]; int n6 = 2; nei6[0] = 4; nei6[1] = 6;
		city city6(x6, y6, s6,nei6,n6);
		//6
		int x7 = 105; int y7 = 13; string s7 = "meridian"; int nei7[10]; int n7 = 2; nei7[0] = 5; nei7[1] = 7;
		city city7(x7, y7, s7,nei7,n7);
		//7
		int x8 = 115; int y8 = 10; string s8 = "dallas"; int nei8[10]; int n8 = 2; nei8[0] = 6; nei8[1] = 8;
		city city8(x8, y8, s8,nei8,n8);
		//8
		int x9 = 130; int y9 = 5; string s9 = "boston"; int nei9[10]; int n9 = 1; nei9[0] = 7;
		city city9(x9, y9, s9,nei9,n9);
		//9
		int x10 = 95; int y10 = 30; string s10 = "llana"; int nei10[10]; int n10 = 2; nei10[0] = 4; nei10[1] = 10;
		city city10(x10, y10, s10,nei10,n10);
		//10
		int x11 = 105; int y11 = 37; string s11 = "san antonio"; int nei11[10]; int n11 = 2; nei11[0] = 9; nei11[1] = 11;
		city city11(x11, y11, s11,nei11,n11);
		//11
		int x12 = 120; int y12 = 42; string s12 = "beevillee"; int nei12[10]; int n12 = 2; nei12[0] =10; nei12[1] = 12;
		city city12(x12, y12, s12,nei12,n12);
		//12
		int x13 = 120; int y13 =47 ; string s13 = "brownsville"; int nei13[10]; int n13 = 1; nei13[0] = 11;
